...
public class ServiceLocator {
    ...
    private ServiceLocator() throws Exception {
        try {
            ...
            String url = "jdbc:postgresql://localhost:5432/ProyectoFinalBiblioteca"; // Al final ponen el nombre de la  base de datos
            String usuario = "postgres";
            String password = "9510"; //Debe reemplazarse por el password en su propia instalación
